...
public:
     ...
     */
    SingletonApp (int &argc, char *argv[], const char *appName, bool allowSecondary = false, Options options = Mode::User, int timeout = 1000);
    ~SingletonApp () override;
