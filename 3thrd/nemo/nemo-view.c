...
static void update_context_menu_position_from_event (NemoView *view, GdkEventButton* event)
{
    g_return_if_fail (NEMO_IS_VIEW (view));
...
static GtkMenu* create_popup_menu (NemoView *view, const char *popup_path)
{
    GtkWidget *menu;

    menu = gtk_ui_manager_get_widget (nemo_window_get_ui_manager (view->details->window), popup_path);
 ...
 **/
void
nemo_view_pop_up_background_context_menu (NemoView *view, GdkEventButton* event)
{
    g_assert (NEMO_IS_VIEW (view));
